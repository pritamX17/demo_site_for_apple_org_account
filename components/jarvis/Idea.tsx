  ...
  return (
    <section ref={ref} id="idea" className="sheet gut" style={{ paddingTop: 150, paddingBottom: 150 }}>
      <div className="p56 on-dark photo-panel idea-panel" style={{ isolation: "isolate", overflow: "hidden" }}>
        ...
        <div className="scrim2" style={{ background: "linear-gradient(90deg,rgba(0,21,38,.10),rgba(0,21,38,0) 40%,rgba(0,46,81,.5) 100%), linear-gradient(180deg,rgba(0,46,81,.12),rgba(0,21,38,0) 30%,rgba(0,21,38,.22))", zIndex: -1 }} />
